...
import { checkSavedBatch } from "../services/savedService";
import { saveProperty, unsaveProperty } from "../services/savedService";
...
function BuyPage() {
  ...
  const fetchProperties = async () => {
    try {
      ...
      // Batch-check saved status for logged-in users
    ...
    <div className="listing-page">
      <div className="listing-header">
        <div className="container">
          ...
          <p>Find your perfect property to buy</p>
        </div>
      </div>
